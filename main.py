...
def process_ai_smart_order(admin_id, customer_id, user_msg):
    try:
        ...
        system_prompt = f"""
        তুমি Simanto, একজন স্মার্ট সেলস অ্যাসিস্ট্যান্ট। তোমার কাজ হলো কাস্টমারের সাথে কথা বলে অর্ডার কনফার্ম করা।
        ...
        তোমার কাজের ধারা:
        - কাস্টমার কথা শুরু করলে বন্ধুত্বপূর্ণভাবে তথ্যগুলো চেয়ে নাও। কাস্টমার একবারে সব দিলে সব একবারে বুঝে নাও।
